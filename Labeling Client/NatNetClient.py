...
class NatNetClient:
    def __init__( self ):
        ...
        self.serverIPAddress = "192.168.56.1"
    ...
    def __unpackMocapData( self, data ):
        ...
        for i in range( 0, markerSetCount ):
            ...
            for j in range( 0, markerCount ):
                ...
                if modelName.decode('utf-8') == "all":
                    markerLocations.append(pos)
        ...
        if self.markerDataListener is not None:
            self.markerDataListener(markerLocations)
        ...
        if( ( self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] > 3 ) or self.__natNetStreamVersion[0] > 2 ):
            ...
            for i in range( 0, labeledMarkerCount ):
                ...
                # trace("\tMarker", id, ":", pos[0], ",", pos[1], ",", pos[2])
    ...
    def __unpackMarkerSetDescription( self, data ):
        ...
        markerSetName = name.decode( 'utf-8' )
        ...
        if self.markerDefinitionListener is not None:
            self.markerDefinitionListener(markerSetName, names)
